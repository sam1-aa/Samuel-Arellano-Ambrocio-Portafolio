    ...
    return (
        <div className='estadisticas_personaje'>
            ...
            <div className='barras'>
                <motion.div initial={{ x:"-100%"}} animate={{x: 0}} transition={{duration:1, delay:0.5}} viewport={{amount:1, once:true}}  className={`barra ${fondo}`} style={{ width: `${tamano_barra}%` }}>?</motion.div>
            </div>
